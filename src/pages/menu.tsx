...
const MenuPage: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      id: 107,
      name: "Gazoz",
      description: "Soğuk ve ferahlatıcı gazoz",
      price: "55₺",
      category: "icecekler",
    ...
    },
    {
      id: 96,
      name: "Meyveli Süt",
      description: "Çilekli, muzlu veya çikolatalı nefis meyveli süt çeşitleri",
      price: "25₺",
      category: "icecekler",
    ...
    },
    {
      ...
      description: "Çikolatalı dondurma ile hazırlanan milkshake",
      price: "150₺",
      category: "icecekler",
